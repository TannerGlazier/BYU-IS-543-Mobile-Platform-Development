...
class RecipeViewModel: ObservableObject {
    ...
    func getRecipeById(_ id: UUID) -> Recipe {
        recipes.first { $0.id == id } ?? Recipe(recipeTitle: "", recipeInstructions: "", recipeIngredients: "", recipeCategory: "", recipeFavorite: false, recipeAuthor: "", recipeDate: Date(), recipeTimeRequired: Date(), recipeNotes: "")
    }
}
