...
class ViewModel {
    ...
    private(set) var filteredItems: [Recipe] = []
    ...
    func addIndependentItem(_ item: Recipe) {
    ...
    func deleteIndependentItem(_ item: Recipe) {
    ...
    func replaceAllItems(
        ...
        var itemTable: [String : Recipe] = [:]
        var independentItemTable: [String : Category] = [:]
    ...
    func saveItem(_ item: Recipe?, title: String, dependentTitles: [String]) {
        if let item {
    ...
    private func createItem(title: String, dependentTitles: [String]) {
        let item = Recipe(title: title, dependentItems: [], independentItems: [])
    ...
    private func editItem(_ item: Recipe, title: String, dependentTitles: [String]) {
        item.title = title
